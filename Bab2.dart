...
void main() {
  ...
  var karyawan2 = KaryawanKontrak("Abdul", umur: 21, peran: "InsinyurJaringan");
  ...
  // Menghapus karyawan dan menambahkannya ke daftar non-aktif
  perusahaan.hapusKaryawan(karyawan2);
  
  // Menampilkan karyawan non-aktif
